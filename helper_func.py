...
# Sebuah fungsi buat periksa apakah user telah subcribe atau belum
...
# Sebuah fungsi buat memeriksa apakah sudah subs atau belum
async def is_subscribed2(filter, client, message):
